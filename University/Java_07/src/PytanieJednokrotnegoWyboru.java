...
public class PytanieJednokrotnegoWyboru extends JPanel implements PytanieTestowe{
	int points[]=new int[5];
	String answers[]=new String[5];
	MyRadioButton b[]=new MyRadioButton[5];
	List<Odpowiedz> odpowiedzi=new ArrayList<>();
	ButtonGroup group = new ButtonGroup();
	public PytanieJednokrotnegoWyboru(String s)throws NoGoodAnswerException,TooManyAnswersException
	{
